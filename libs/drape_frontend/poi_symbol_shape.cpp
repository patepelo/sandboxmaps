...
drape_ptr<dp::OverlayHandle> PoiSymbolShape::CreateOverlayHandle(m2::RectD const & pixelRect) const
{
  ...
  // TODO map symbol name to localised string
  dp::AccessibilityNodeInfo accessibilityInfo(m_params.m_symbolName, dp::ExplorationType::ANNOUNCE_LABEL_ON_LONG_HOVER |
                                                                         dp::ExplorationType::SIGNAL_PRESENCE_ALWAYS);
